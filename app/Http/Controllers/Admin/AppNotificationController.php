...
class AppNotificationController extends Controller
{
    ...
    {
        $appNoti = app_notification::where('notification_type','1')->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($type == 'direct') {
            // $player_ids = User::where('noti_status', 1)->pluck('player_id')->toArray();
    ...
    public function edit(app_notification $app_notification)
    {
        return view('app_notification.edit', compact('app_notification'));
    }

    public function update(Request $request, app_notification $app_notification)
    {
        // $other_type                 = strip_tags($request->input('type'));
        $type                       = strip_tags($request->input('notification_type'));
        $notification_title         = strip_tags($request->input('notification_title'));
    ...
    public function destroy(app_notification $app_notification)
    {
